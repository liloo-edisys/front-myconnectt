...
const ProfileModal = ({ isOpen, onClose, onSelectProfile }) => {
  const profiles = [
    { id: 1, name: "Support Technique", avatar: "/api/placeholder/40/40", status: "active" },
    { id: 2, name: "Service Client", avatar: "/api/placeholder/40/40", status: "active" },
    { id: 3, name: "Commercial", avatar: "/api/placeholder/40/40", status: "inactive" },
              ...
              <Box sx={{ position: 'relative', marginRight: 2 }}>
                ...
                <Box
                  sx={{
                    ...
                    backgroundColor: profile.status === 'active' ? '#4caf50' : '#9e9e9e',
                  }}
                />
              </Box>
              <Box sx={{ flex: 1 }}>
