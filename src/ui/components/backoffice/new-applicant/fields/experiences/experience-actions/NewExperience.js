    ...
    <Modal show={toogleExperienceForm} width={600} backdrop="static" size="lg">
      ...
      <Formik
        ...
        onSubmit={(values, { setSubmitting }) => {
          ...
          addSelectedApplicantExperience(values, dispatch);
          hideExperienceForm();
          setSelectedExperience(null);
        }}
      >
              ...
              <div className="my-10">
                ...
                <div>
                  {/*<div className="d-flex justify-content-center mt-5">
                    <div
                      className="alert alert-custom alert-notice alert-light-warning fade show px-5 py-0"
                      role="alert"
                    >
                      <div className="alert-icon">
                        <i className="flaticon-warning"></i>
                      </div>
                      Si vous êtes en poste, indiquez la date d'aujourd'hui pour
                      la date de fin. Le bouton "en poste" sera alors active.
                    </div>
                  </div>*/}
