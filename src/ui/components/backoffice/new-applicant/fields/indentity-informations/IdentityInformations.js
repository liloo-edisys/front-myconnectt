...
function IdentityInformations(props) {
  ...
  const handleChangeAdditionalAddress = additionalAddress => {
                ...
                <div className="pb-5 width-full">
                  ...
                  <div className="row">
                    <div className="form-group col-sm-12 col-xl-6">
                      ...
                      <div className="input-group">
                        <AddressSearchInput
                          address={values.address} // Utiliser values.address au lieu de address
                          setAddress={addr => setFieldValue("address", addr)}
                          ...
                          onAddressSelect={suggestion => {
                            ...
                            // Utiliser setFieldValue au lieu de setState
                            setFieldValue("city", suggestion.localName);
                            setFieldValue("postalCode", suggestion.postalCode);
                            setFieldValue("address", suggestion.address); // Si nécessaire

                            // Garder seulement position en état local si nécessaire
