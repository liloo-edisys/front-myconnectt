...
function ProofOfAddressModal(props) {
  ...
  const onDeleteDocument = id => {
    ...
    removeOneSelectedApplicantDocument(body, "proofOfAddress", dispatch);
    //removeOneDocument(body, "proofOfAddress", dispatch);
  };
                  ...
                  >
                    ...
                    {touched.imageArray && errors.imageArray ? (
                      <div className="fv-plugins-message-container">
                        <div className="fv-help-block">{errors.imageArray}</div>
                      </div>
                    ) : values.imageArray ? (
                      <div
