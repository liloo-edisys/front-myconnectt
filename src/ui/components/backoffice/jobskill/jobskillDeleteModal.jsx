...
export function JobskillDeleteModal(props) {
  ...
  const handleDeleteApplicant = () => {
    const DELETE_JOBSKILLS_API = api + "api/JobSkill/?id=" + id;
    axios
      .delete(DELETE_JOBSKILLS_API)
      .then(res => {
        getData();
        onHide();
  ...
  return (
    ...
    >
      ...
      <Modal.Body>
        <span>
          <FormattedMessage
            id="TEXT.DELETE.JOBSKILL.DESCRIPTION"
