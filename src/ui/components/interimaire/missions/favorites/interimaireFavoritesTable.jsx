...
function InterimaireMissionsTable({ refresh }) {
  ...
  const onSelectMission = annonce => {
    history.push(`/favorites/display/${annonce.id}`);
  };
    ...
    <div className="d-flex justify-content-center mt-5">
      ...
      >
        ...
        <div className="alert-text">
          <FormattedMessage id="MESSAGE.NO.FAVORITES" />
        </div>
      </div>
    </div>
  );

  const FavoritesUIContext = useFavoritesUIContext();
  const missionsUIProps = useMemo(() => {
    return {
      ids: FavoritesUIContext.ids,
      setIds: FavoritesUIContext.setIds,
      queryParams: FavoritesUIContext.queryParams,
      setQueryParams: FavoritesUIContext.setQueryParams,
      openDisplayDialog: FavoritesUIContext.openDisplayDialog,
      openApproveDialog: FavoritesUIContext.openApproveDialog,
      openDeclineMatchingDialog: FavoritesUIContext.openDeclineMatchingDialog
    };
  }, [FavoritesUIContext]);
            ...
            <div className="d-flex flex-row justify-content-between">
              ...
              <div className="d-flex flex-row align-items-center">
                <p className="ml-5" style={{ margin: 0 }}>
                  <FormattedMessage
                    id="MESSAGE.FAVORITES.TOTALCOUNT"
                  ...
                  <div className="annonce_container box-shadow-interimaire">
                    ...
                    <div className="annonce_footer_container">
                      ...
                      <Link
                        ...
                        to={`/favorites/approve/${annonce.id}`}
                      >
                      ...
                      <Link
                        ...
                        to={`/favorites/remove/${annonce.id}`}
                      >
