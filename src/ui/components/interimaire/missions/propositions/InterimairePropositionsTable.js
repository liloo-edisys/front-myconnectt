...
import { useInterimairePropositionsUIContext } from "./InterimairePropositionsUIContext";
...
import PropositionsColumnFormatter from "../../column-formatters/MissionsMatchingColumnFormatter";
...
function InterimairePropositionsTable({ refresh }) {
  ...
  const onSelectMission = annonce => {
    history.push(`/propositions/display/${annonce.id}`);
  };
                    ...
                    <div className="annonce_container box-shadow-interimaire">
                      ...
                      <div className="annonce_footer_container">
                        <Link
                          ...
                          to={`/propositions/approve/${annonce.id}`}
                        >
                        ...
                        <Link
                          ...
                          to={`/propositions/remove/${annonce.id}`}
                        >
...
export default InterimairePropositionsTable;
