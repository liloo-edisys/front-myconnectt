  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {intl.formatMessage({ id: "CLIENT.WIZARD.THIRD.STEP.TITLE" })}
        </h3>
        <a
          href="#"
          onClick={() => {
      ...
      >
        ...
        <div>
          <div>
            {intl.formatMessage({ id: "CLIENT.WIZARD.THIRD.STEP.CHUNK1" })}
          </div>
        </div>
      </div>
    </div>
...
export default injectIntl(connect()(ThirdTooltip));
