...
function DocumentsTable(props) {
  ...
  const { documentsList, account } = useSelector(state => ({
    documentsList: state.missionsReducerData.recieptList,
            ...
            <div className="d-flex flex-row justify-content-between">
              ...
              <div className="d-flex flex-row align-items-center">
                <p className="ml-5" style={{ margin: 0 }}>
                  Total de {documentsList.totalcount} facture(s)
                </p>
              </div>
            </div>
          </div>
                ...
                <div className="annonce_container box-shadow-interimaire">
                  <div>
                    <div className="annonce_header_container pb-0">
                      <h2 className="annonce_header_title">Facture</h2>
                    </div>
