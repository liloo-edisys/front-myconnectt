...
import { HeaderMenuInterimaire } from "./HeaderMenuInterimaire";
...
export function HeaderMenuWrapper() {
    ...
    return <>
        ...
        <div className="header-menu-wrapper header-menu-wrapper-left" id="kt_header_menu_wrapper">
            ...
            {/*begin::Header Menu*/}
            {
                isInterimaire ? <HeaderMenuInterimaire layoutProps={layoutProps} /> : <HeaderMenuClient layoutProps={layoutProps} />
            }
