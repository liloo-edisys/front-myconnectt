...
export function UserProfileDropdown() {
  ...
  const {parsed} = useSelector(state => state.interimairesReducerData);
        ...
        >
          <div className={"btn btn-icon w-auto btn-clean d-flex align-items-center btn-lg px-2"}>
            ...
            <span className="symbol symbol-35 symbol-light-success">            
             { parsed && !isNullOrEmpty(parsed.applicantPicture) && <img alt="avatar" src={"data:image/"+ parsed.applicantPicture.filename.split(".")[1] + ";base64," + parsed.applicantPicture.base64}/>}
            </span>
          </div>
        </Dropdown.Toggle>
        <Dropdown.Menu
